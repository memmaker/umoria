...
<li><kbd>Ctrl+X</kbd> saves and ends the session, as in the original; reload the page (or press <em>Play again</em>) to continue.</li>
<li>When your character dies the game is over; the next start rolls a new character.</li>
...
<li>Window layout, zoom, the sound/music switches and the high scores are stored in the same browser storage.</li>
...
parts.append(section('about', 'About the game',
                     guide.pop('How Umoria differs from Angband')))
